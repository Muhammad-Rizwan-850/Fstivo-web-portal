...
import { POST } from '@/app/api/payments/easypaisa/create/route';

describe('POST /api/payments/easypaisa/create', () => {
  beforeEach(() => {
    resetMockDatabase();
    jest.clearAllMocks();
  });
  ...
  describe('successful request', () => {
    it('should return 201 when valid input provided', async () => {
      ...
      // 3. Build request
      const request = new NextRequest('http://localhost:3000/api/payments/easypaisa/create', {
        method: 'POST',
